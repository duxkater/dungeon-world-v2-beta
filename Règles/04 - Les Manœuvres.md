...
La magnitude (mag) représente la puissance globale d'un sort. Le MJ a le dernier mot sur la magnitude d'un sort, en fonction de la gravité de l'effet, de la cible, de la portée, de la durée, de la zone d'effet et d'autres facteurs similaires. Les directives ci-dessous devraient vous aider :
- mag 0 — Magie mineure (parfois appelée tours de magie, oraisons ou sorts élémentaires) pouvant être exécutée même par des débutants. Elle correspond aux niveaux de sort 0 et 1 de la 5e édition. Ces effets pourraient être obtenus sans magie. Exemples : tirer un projectile magique (1d4 dégâts) ; soigner éraflures et contusions (1d4 PV restaurés) ; communiquer à travers une pièce ; invoquer un minuscule esprit follet ; lire les émotions actuelles d'une personne ; charmer quelqu'un de distrait ou d'épuisé ; provoquer un sommeil léger et agité ; ralentir une chute ; rendre quelqu'un invisible pendant quelques secondes ; réparer l'usure courante.
- mag 1 — Magie standard couramment pratiquée par des lanceurs de sorts ordinaires ; correspond aux niveaux de sort 2 et 3 de la 5e édition. Réaliser un effet similaire sans magie nécessiterait des efforts complexes, longs ou coordonnés. Exemples : tirer une flèche d'acide (1d8 dégâts #perforants) ; soigner des coupures profondes (1d8 PV restaurés) ; communiquer à travers le pays ; invoquer un diablotin rusé ; lire les pensées superficielles d'une personne ; charmer une personne ordinaire ; provoquer un sommeil profond mais naturel ; léviter jusqu'à une distance #proche ; rendre quelqu'un invisible pendant quelques minutes ; créer un objet ordinaire à partir de matières premières.
- mag 2 — Magie majeure sollicitant au maximum les capacités de la plupart des praticiens ; seuls les maîtres peuvent l'exécuter de manière fiable au quotidien. Similaire aux niveaux de sort 4 et 5 de la 5e édition, ces effets nécessiteraient, sans magie, des efforts, une coordination, des outils, du temps et/ou un entraînement extrêmes. Exemples : tirer une boule de feu explosive (1d12 dégâts #perforants) ; soigner des fractures (1d12 PV restaurés) ; communiquer avec un fantôme ou un esprit ; invoquer un serviteur élémentaire ; lire le désir secret d'une personne ; charmer un esprit méfiant ou hostile ; provoquer un sommeil qui ne prendra fin que le lendemain ; voler pendant quelques minutes ; rendre quelqu'un invisible pendant une heure ; faire apparaître un objet ordinaire à partir de rien.
- mag 3 — Magie de haut niveau, inaccessible à quiconque n'est pas un maître en la matière. Équivalente aux niveaux de sort 6 et 7 de la 5e édition, elle permet des prouesses quasi impossibles à accomplir sans magie, même avec toute l'aide du monde. Exemples d'effets : émettre un nuage de gaz empoisonnant ceux qui le respirent (dégâts perforants : 1d12+1d6) ; ramener à la vie une personne à l'agonie (restauration de 1d12+1d6 PV) ; communiquer avec un autre plan d'existence ; invoquer un gardien démoniaque ; contrôler un esprit affaibli ; plonger quelqu'un dans un sommeil d'un an ; voler pendant quelques heures ; rendre quelqu'un invisible pour le reste de la journée ; transformer une créature en une autre de nature similaire ; créer un portail vers une autre dimension ; soulever par télékinésie un rocher ou une petite maison ; se téléporter sur quelques kilomètres.
- mag 4+ — Magie mythique que certains maîtres passent leur vie entière à tenter de maîtriser ; seuls les plus grands parmi les grands peuvent produire de tels effets par un simple sort, la plupart devant recourir à un rituel. Équivalente aux niveaux de sort 8 et 9 de la 5e édition, cette magie permet des exploits dont on ne trouve trace que dans les contes et légendes. Exemples d'effets : prononcer un mot de pouvoir interdit tuant instantanément une cible ou lui infligeant des dégâts perforants (1d12+1d10) ; ressusciter un mort ; communiquer à travers le temps et l'espace ; invoquer un monstrueux béhémoth ; contrôler un esprit extraterrestre ou protégé ; plonger quelqu'un dans un sommeil éternel ; voler indéfiniment ; créer un objet magique ou un artefact ; se téléporter, soi et ses alliés, n'importe où dans le monde.
...
>Les complications associées à chaque approche ne sont que des suggestions pour le MJ ; celui-ci est libre d'en choisir d'autres si elles conviennent mieux à la situation. Quoi qu'il en soit, les complications doivent sembler justifiées au regard des motivations du PNJ ainsi que des actions passées et présentes des PJ.
## Percer à jour (+SAG)

Lorsque vous observez attentivement quelqu’un au cours d’une conversation, lancez +SAG.
...
- Comment pourrais-je vous amener à .......... ?
- Que ressentez-vous vis-à-vis de .......... ?
- Quel est votre désir le plus profond ?

>En tant que joueurs et MJ, posez et formulez toujours ces réponses de manière claire et explicite. Toutefois, en incarnant votre personnage, vous pouvez jouer sur le non-dit et les sous-entendus pour créer des dialogues dramatiques intenses. Peut-être posez-vous une question à voix haute, ou peut-être analysez-vous la posture de votre interlocuteur pour en déduire ses intentions. Il arrive qu’un personnage donne une réponse verbale alors que son regard en trahit une autre, sans même qu’il en ait conscience.

>Si toutes les réponses doivent être véridiques, elles ne sont pas tenues d’être exhaustives. Vos réponses doivent être suffisamment détaillées pour servir l’intensité dramatique de la scène et rester cohérentes avec la manière dont la question a été abordée dans la fiction. Observer discrètement le comportement de quelqu’un peut révéler un immense sentiment de culpabilité, peut-être même lié à sa famille. En l’amenant à se confier, vous pourriez découvrir qu’il a tué accidentellement son frère ou sa sœur et que ce remords le ronge depuis des années.
## Se faufiler (+DEX)

Lorsque vous tentez de passer inaperçu, lancez +DEX.
- Sur un 10+, vous restez totalement indétecté.
- Sur un 7-9, vous y parvenez, mais le MJ choisit une option :
...
Lorsque vous affrontez un ennemi au combat, lancez les dés +FOR au corps à corps ou +DEX à distance (ou avec des armes \#précises), puis infligez vos dégâts et subissez les siens.

- Sur un 10+, choisissez une option :
	- Un allié saisit une opportunité fugace
	- Vous infligez les dégâts maximums
	- Vous subissez les dégâts minimums
- Sur un 7-9, choisissez plutôt l'une de ces options :
...
Quel que soit le résultat, vous découvrez toujours quelque chose ; le MJ vous dira quoi.

- Sur un 10+, votre découverte est claire et significative.
- Sur un 7-9, choisissez une option parmi les suivantes :
...
>« Enquêter » implique une activité bien plus active et concrète que le simple fait de jeter un coup d’œil autour de soi pour observer les lieux. Vous pourriez, par exemple, passer vos doigts sur les briques d’un mur pour trouver une porte dérobée, interroger des témoins d’un meurtre récent ou coller votre oreille contre une porte pour entendre une conversation étouffée. Si vous voulez simplement savoir ce que vous percevez autour de vous, posez la question au MJ et il vous répondra.
# Manœuvres spéciales
...
- Quelqu’un a-t-il approfondi l’une de ses relations ?
- Avons-nous vaincu une menace dangereuse, visité un nouveau lieu et/ou trouvé un trésor mémorable ?
- Avons-nous appris quelque chose de nouveau et d’important sur le monde ou sur des PNJ ?

Pour chaque réponse affirmative, tout le monde note de l’XP.

>Concernant la première question, il est important de préciser que si quelqu’un a approfondi l’une de ses relations, tous les membres du groupe gagnent un point d’XP.

>Si vous n’êtes pas sûrs qu’une menace soit « dangereuse », qu’un lieu soit « nouveau », etc., discutez-en en groupe pour vous mettre d’accord. En l’absence de consensus, le MJ a le dernier mot.
## Affronter la mort

Lorsque vos PV tombent à 0, vous êtes « Sans défense » jusqu’à ce que vous récupériez des PV ou que la scène s’achève. Tant que vous êtes Sans défense, la moindre perte de PV entraîne votre mort. Si vous récupérez des PV, verrouillez l’un de vos États ; vous n’êtes alors plus Sans défense.

Lorsque vous entreprenez une action décisive alors que vous êtes Sans défense, choisissez l’une des options suivantes avant de résoudre l’action :
- Tenter le tout pour le tout face à la mort : lancez les dés sans bonus (jet pur).
	- Sur un 10+, vous surpassez la douleur ; récupérez la moitié de vos PV max (arrondie à l’inférieur) puis résolvez votre action.
	- Sur un 7-9, le MJ désigne la partie de vous qui ne survivra pas ; acceptez cette perte et récupérez 1 PV, ou refusez de la sacrifier et mourez après avoir agi.
	- Sur un 6-, vous êtes trop blessé pour agir et mourrez avant la fin de la scène ; c’est vous qui décidez du moment. Quels sont vos derniers mots ?
- Partir en beauté : prenez brièvement le contrôle de la scène, décrivez un ultime exploit que vous accomplissez, puis mourez.

>Être Sans défense ne signifie pas nécessairement être inconscient, mais vous ne pouvez rien entreprendre d’important (comme la plupart des Manœuvres) sans que cela soit considéré comme une « action décisive ». Vous pouvez peut-être parler, mais pas avec assez d’éloquence pour « Tirer les ficelles ». Vous pouvez peut-être vous souvenir de choses, mais pas assez pour « Étaler son savoir ».

>Lorsque vous « prenez brièvement le contrôle de la scène », vous décrivez comment votre personnage surmonte toutes les épreuves dans ses derniers instants. Vous devez tout de même rester cohérent et garder l’action dans le domaine du possible — ne vous envolez pas au hasard vers le soleil pour le transformer en licorne — mais, au-delà de cela, c’est à vous de choisir ce qui semble satisfaisant pour votre personnage au moment de mourir.
## Monter de niveau

Lorsque vous cochez la dernière case de la piste d’expérience de votre personnage, videz la piste, augmentez votre niveau de 1, augmentez vos PV actuels et maximum de 1 (jusqu’à un bonus de +10) et obtenez une amélioration correspondant à votre nouveau niveau (ou à un niveau inférieur).

>Vous pouvez monter de niveau en pleine scène ou choisir de conserver l’amélioration pour après la séance (lorsque vous aurez le temps d’examiner les options).
...
>L'expression « la situation dans le monde empire » signifie que les menaces et autres dangers du monde fantastique se rapprochent de leurs objectifs. Parfois, cela se manifeste de manière évidente ; d'autres fois, c'est plus subtil et nécessite une enquête. Des événements urgents peuvent même interrompre cette action.
...
- Cela nécessitera ..........
- L’effet sera peu fiable ou limité
- Vous et vos alliés risquerez ..........
- Vous aurez besoin de l’aide de ..........
- Vous devrez détruire .......... pour y parvenir

Une fois toutes les conditions remplies, le rituel est achevé et l’effet magique se produit.

>Tout PJ peut accomplir un rituel. Même si vous ne savez pas lancer de sort, vous pouvez puiser dans une source de puissance pour obtenir des effets qui seraient autrement impossibles. C’est au MJ de déterminer ce qui constitue une source de puissance appropriée.
...
Lorsque vous traversez un territoire hostile, choisissez une destination, un meneur et un mode de déplacement :

- Rapidement, en jouant le tout pour le tout — -1 au jet, tout le monde coche un État ; vous arrivez plus tôt que prévu
- À allure normale — +1 au jet, seul le meneur coche un État ; vous arrivez à l'heure prévue
- Lentement et prudemment — +2 au jet ; vous arrivez plus tard que prévu

Ensuite, le meneur effectue le jet avec le modificateur correspondant.
- Sur un 10+, vous arrivez avec un avantage ; le MJ vous dira lequel.
- Sur un 7-9, vous arrivez à destination mais devez choisir une option :
...
>Vous devez également traverser un « territoire hostile » : cela peut être un pays ennemi, une forêt dangereuse, un réseau de grottes infesté de monstres ou une route infestée de bandits. Le MJ a le dernier mot pour déterminer quel territoire est considéré comme « hostile ».

>Un « avantage » peut être une ruine précieuse, un PNJ utile, un arbre magique, un trésor abandonné ou autre chose encore. Même si son utilité ne saute pas immédiatement aux yeux, avec un peu d'effort et/ou des idées ingénieuses, cela peut s'avérer payant.