...
Je suis ..........
*Par exemple : peuple-chat, firbolg, créature de gelée, etc. Vos parents étaient-ils des gens respectueux de la loi ?*
## Communauté

J'ai été élevé.e ...........
*Par exemple : les habitants de l'Outreterre, un gang de rue, les connards privilégiés, etc. Avez-vous été directement confronté à la criminalité ?*
## Passé
...
Lorsque vous Défiez le danger ou vous Faufilez en utilisant l'une de vos compétences de Crapule, vous trichez; lancez 1d8 + 1d6 (au lieu de 2d6).
...
- Choisissez une arme (ou créez en une avec le MJ) :
	...
	- dagues dissimulées (dégâts 1d4) #munitions #main #corps-à-corps #perforant #précis #dissimulé #léger 
...
Si vous ne possédez pas la Manoeuvre de départ Ficelles du métier, vous l’obtenez, mais uniquement pour ces deux compétences. Si vous possédiez déjà l’une de ces compétences, travaillez avec le MJ pour en créer une nouvelle en remplacement de chaque compétence redondante.

Attaque sournoise — Lorsque vous Échangez des coups +Dex, si votre adversaire est distrait ou pris en tenaille (et que vous portez une armure légère ou aucune armure) :
- sur un 10+, vous pouvez choisir d’infliger les dégâts maximums gratuitement.
...
- il peut être administré par contact (sinon, c’est par ingestion)
- le MJ n’ajoute ni « et » ni « mais » à l’effet (sinon, il le fait)
- il est indétectable
- vous récupérez une utilisation de votre kit d’empoisonneur
### Rôdeur des ombres
...
Si vous la possédez déjà, travaillez plutôt avec le MJ pour créer une nouvelle Compétence de Crapule.

Lorsque vous utilisez une Compétence de Crapule pour vous faufiler, lancez 1d10+1d6 (au lieu de 1d8+1d6).

Lorsque vous cherchez une cachette, le MJ vous indiquera le meilleur endroit, mais c’est à vous de l’atteindre.
## Cambrioleur
...
Si vous ne possédez pas la Manoeuvre de départ Ficelles du métier, vous l'obtenez, mais uniquement pour ces deux compétences. Si vous possédiez déjà l'une de ces compétences de Crapule, travaillez avec le MJ pour en créer une nouvelle en remplacement de chaque compétence redondante.

Flair pour le trésor — Lorsque vous « Déterrez des secrets », quel que soit le résultat du jet, vous pouvez également demander : « Y a-t-il ici des objets de valeur que j'ignore ? » Si oui, obtenez l'avantage sur le prochain jet pour tenter de les obtenir.
### Mieux vaut avoir de la chance que du talent
...
- Qu'est-ce qui m'échappe à son sujet ?
### Dégainage rapide

Lorsque le MJ ou un autre joueur s'apprête à effectuer une Manoeuvre, avec sa permission (hors jeu), vous pouvez cocher un État pour l'interrompre et agir immédiatement à la place.
### Disparition

Lorsque vous êtes certain que personne ne vous observe directement, vous pouvez disparaître totalement de la scène et ne réintégrer le récit qu'une fois la scène terminée. Si vous êtes en difficulté ou dans une situation critique, demandez au MJ ce que vous devez faire pour disparaître ; il vous indiquera jusqu'à (4 - Sag) des conditions suivantes :
- Votre réapparition s'accompagnera d'ennuis
- Vous devez d'abord risquer/ruser pour obtenir/voler _____________
- Vous devez laisser quelque chose d'important derrière vous
- Vous devez cocher un État au cours du processus
## Espion
