*Un artiste jusqu'au bout des ongles, animé par des ambitions qui vont bien au-delà du simple désir de plaire au public.*

*Au niveau 1, vos PV max sont de 8 et votre Charisme est de +2. Choisissez d'avoir +1 en Dextérité ou en Intelligence, puis attribuez +1, 0 et -1 aux autres caractéristiques.*
# Origines
## Ascendance

Je suis ..........
*par ex. gnome, orc, géantide, etc. Qu’est-ce qui distingue votre art de celui de votre peuple ?*
## Communauté

J'ai été élevé.e ...........
*par ex. des érudits insatiablement curieux, des gens immensément riches, des artistes reclus, etc. De quelle manière les circonstances de votre vie influencent-elles encore votre art ?*
## Passé

Autrefois, j'étais ........
*Par exemple : gladiateur, bibliothécaire, artiste de spectacle, etc. Pourquoi avez-vous choisi l'art et le danger plutôt qu'une vie plus simple ?*
# Relations
...
Vous vous exprimez et touchez les autres grâce à un talent artistique particulier. S'agit-il de cuisine, de musique, de poésie ou d'autre chose ? Lorsque vous présentez votre art devant un public, lancez les dés +CHA.
...
Pour votre apparence, choisissez un par ligne :
☐ costume coloré ☐ tenue fantaisiste ☐ tenue en cuir avec masque
☐ luth robuste      ☐ wok immense      ☐ nombreux pinceaux
# Avancements
...
Vous avez étudié divers sujets ésotériques, notamment :

- [ ] Bestiaire des créatures les plus insolites
- [ ] Dieux et leurs serviteurs
- [ ] Grandes chroniques du monde connu
- [ ] Légendes des héros d'autrefois
- [ ] Sortilèges et magie
- [ ] Les morts et les morts-vivants
- [ ] Les sphères planaires.

Désignez-en un comme sujet actif lorsque vous choisissez cette capacité.
Vous pouvez poser au MJ des questions sur votre sujet actif ; le nombre de questions par séance est égal à votre score d'INT. Le MJ y répondra honnêtement.
...
Lorsque vous accomplissez une tâche importante pour un PNJ pertinent (au jugement du MJ), vous détenez une dette envers vous de sa part.

Tant que vous détenez une dette envers quelqu'un :
- Considérez tout résultat de 6 ou moins lors de « Manipuler » à son encontre comme un résultat de 7 à 9.
- Vous pouvez toujours lui demander « De quoi as-tu vraiment besoin en ce moment ? » lorsque vous utilisez « Percer à jour », quel que soit le résultat du jet.
- Cette personne vous accordera des faveurs mineures (à ses yeux), telles que : un petit financement, une mise en relation, le prêt d'objets pour une durée limitée, etc.

Lorsque vous encaissez votre dette, choisissez l'une des options suivantes :
...
- Sur un 7-9, une seule :
	...
	- Vos alliés sont ignorés ; ils obtiennent une opportunité
	- Votre mise en scène n’est pas interrompue, ni par la parole ni par la violence
- Sur un 6-, l’attention attire une action violente ; cochez 1 case d’XP et le MJ effectue une Manœuvre.