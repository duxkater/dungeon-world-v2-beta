*Bien plus qu'un simple prêtre : un émissaire divin, armé d'acier et de pouvoirs venus d'en haut.*

*Au niveau 1, vos PV max sont de 8 et votre Sagesse est de +2. Choisissez d'avoir +1 en Force ou en Charisme, puis attribuez +1, 0 et -1 aux autres caractéristiques.*
# Origines
## Ascendance

Je suis ..........
*Par exemple : halfelin, homme-hibou, tieffelin, etc. Quel regard portent-ils sur votre foi ?*
## Communauté

J'ai été élevé.e ...........
*Par exemple : une bande de voyous, des croyants fervents, des représentants de l'ordre, etc. Quelles traditions honorez-vous encore indépendamment de votre divinité ?*
## Passé

Autrefois, j'étais ........
*par ex. shérif, gamin des rues, apprenti sorcier, etc. Quelle « intervention divine » vous a poussé à tout quitter pour devenir clerc ?*
# Relations
...
- Je dois souvent servir de médiateur pour eux 
- Ma divinité m'a révélé leur destinée
- Nous partageons des croyances très similaires
- Ils servent une puissance opposée à ma divinité
- Ils ont un passé commun avec un ennemi juré de ma divinité
...
- Choisissez une arme (ou créez en une avec le MJ) :
	- masse d'armes consacrée dégâts 1d6 #main + bouclier ○ utilisation. Cochez pour ignorer tous les dégâts d'une attaque
	- bâton ordinaire dégâts 1d6 #corps-à-corps #main
	- filet renforcé dégâts 0 #corps-à-corps #main ○ utilisation. Cochez pour piéger une créature de taille moyenne ou plusieurs petites créatures dessous

- Choisissez deux objets parmi :
	- fioles d’eau bénite #sacré #contact ○ ○ ○ utilisations. Cochez pour ignorer toutes les résistances d’un ennemi de votre divinité jusqu’à la fin de la scène
	- armure de cuir (réduction de dégâts de 1 : réduit tous les dégâts subis de 1, jusqu’à un minimum de 1). Force minimale de +1 pour une utilisation optimale
	- soins ○ ○ utilisations. Cochez pour permettre à quelqu’un de doubler les PV récupérés lors de sa prochaine guérison ou pour soigner un état ou une affliction
	- fournitures pieuses ○ ○ ○ utilisations. Cochez pour fouiller et trouver un objet lié au culte de votre divinité, comme des bougies, un encensoir, de l’encens ou des vêtements liturgiques
...
☐ uniforme ancien ☐ manteau en peau prisé ☐ robes simples
☐ tatouage animé ☐ amulette bénie ☐ reliquaire volé
# Avancements
...
Lorsque vous « Tirez les ficelles », vous avez accès à l'approche suivante :
